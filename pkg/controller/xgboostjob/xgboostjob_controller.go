...
import (
	...
	xgboostjobsv1alpha1 "github.com/kubeflow/xgboost/pkg/apis/xgboostjobs/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &xgboostjobsv1alpha1.XGBoostJob{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &xgboostjobsv1alpha1.XGBoostJob{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=xgboostjobs.kubeflow.org,resources=xgboostjobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=xgboostjobs.kubeflow.org,resources=xgboostjobs/status,verbs=get;update;patch
func (r *ReconcileXGBoostJob) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the XGBoostJob instance
	instance := &xgboostjobsv1alpha1.XGBoostJob{}

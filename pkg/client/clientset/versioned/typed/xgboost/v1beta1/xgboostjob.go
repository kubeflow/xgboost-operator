...
type XGBoostJobInterface interface {
	Create(*v1beta1.XGBoostJob) (*v1beta1.XGBoostJob, error)
	Update(*v1beta1.XGBoostJob) (*v1beta1.XGBoostJob, error)
	UpdateStatus(*v1beta1.XGBoostJob) (*v1beta1.XGBoostJob, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.XGBoostJob, error)
	List(opts v1.ListOptions) (*v1beta1.XGBoostJobList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.XGBoostJob, err error)
	XGBoostJobExpansion
}
...
func newXGBoostJobs(c *KubeflowV1beta1Client, namespace string) *xGBoostJobs {
	return &xGBoostJobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *xGBoostJobs) Get(name string, options v1.GetOptions) (result *v1beta1.XGBoostJob, err error) {
	result = &v1beta1.XGBoostJob{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *xGBoostJobs) List(opts v1.ListOptions) (result *v1beta1.XGBoostJobList, err error) {
	result = &v1beta1.XGBoostJobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("xgboostjobs").
...
func (c *xGBoostJobs) Create(xGBoostJob *v1beta1.XGBoostJob) (result *v1beta1.XGBoostJob, err error) {
	result = &v1beta1.XGBoostJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("xgboostjobs").
...
func (c *xGBoostJobs) Update(xGBoostJob *v1beta1.XGBoostJob) (result *v1beta1.XGBoostJob, err error) {
	result = &v1beta1.XGBoostJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("xgboostjobs").
...
func (c *xGBoostJobs) UpdateStatus(xGBoostJob *v1beta1.XGBoostJob) (result *v1beta1.XGBoostJob, err error) {
	result = &v1beta1.XGBoostJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("xgboostjobs").
...
func (c *xGBoostJobs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.XGBoostJob, err error) {
	result = &v1beta1.XGBoostJob{}

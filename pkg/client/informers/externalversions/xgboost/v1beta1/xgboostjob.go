...
import (
	...
	xgboostv1beta1 "github.com/kubeflow/xgboost-1/pkg/apis/xgboost/v1beta1"
	...
	v1beta1 "github.com/kubeflow/xgboost-1/pkg/client/listers/xgboost/v1beta1"
...
type XGBoostJobInformer interface {
	...
	Lister() v1beta1.XGBoostJobLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeflowV1beta1().XGBoostJobs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeflowV1beta1().XGBoostJobs(namespace).Watch(options)
			},
		},
		&xgboostv1beta1.XGBoostJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *xGBoostJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&xgboostv1beta1.XGBoostJob{}, f.defaultInformer)
}

func (f *xGBoostJobInformer) Lister() v1beta1.XGBoostJobLister {
	return v1beta1.NewXGBoostJobLister(f.Informer().GetIndexer())
}

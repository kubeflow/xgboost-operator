...
import (
	...
	xgboostv1alpha1 "github.com/kubeflow/xgboost-1/pkg/apis/xgboost/v1alpha1"
	...
	v1alpha1 "github.com/kubeflow/xgboost-1/pkg/client/listers/xgboost/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeflowV1alpha1().XGBoostJobs(namespace).List(options)
			},
...
func (f *xGBoostJobInformer) Lister() v1alpha1.XGBoostJobLister {
	return v1alpha1.NewXGBoostJobLister(f.Informer().GetIndexer())
}

...
type XGBoostJobLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.XGBoostJob, err error)
...
// List lists all XGBoostJobs in the indexer.
func (s *xGBoostJobLister) List(selector labels.Selector) (ret []*v1beta1.XGBoostJob, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.XGBoostJob))
	})
	return ret, err
}
...
type XGBoostJobNamespaceLister interface {
	...
	Get(name string) (*v1beta1.XGBoostJob, error)
...
// List lists all XGBoostJobs in the indexer for a given namespace.
func (s xGBoostJobNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.XGBoostJob, err error) {
...
// Get retrieves the XGBoostJob from the indexer for a given namespace and name.
func (s xGBoostJobNamespaceLister) Get(name string) (*v1beta1.XGBoostJob, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("xgboostjob"), name)
	}
	return obj.(*v1beta1.XGBoostJob), nil
}

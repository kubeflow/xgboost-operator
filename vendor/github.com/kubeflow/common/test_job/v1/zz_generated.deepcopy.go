...
import (
	operator_v1 "github.com/kubeflow/common/operator/v1"
	...
	*out = *in
	if in.RunPolicy != nil {
		...
		if *in == nil {
			...
			*out = new(operator_v1.RunPolicy)
			(*in).DeepCopyInto(*out)
		}
	}
	if in.TestReplicaSpecs != nil {
		in, out := &in.TestReplicaSpecs, &out.TestReplicaSpecs
		*out = make(map[TestReplicaType]*operator_v1.ReplicaSpec, len(*in))
		for key, val := range *in {
			if val == nil {
				(*out)[key] = nil
			} else {
				(*out)[key] = new(operator_v1.ReplicaSpec)

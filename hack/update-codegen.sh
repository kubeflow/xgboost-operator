...
${CODEGEN_PKG}/generate-groups.sh "defaulter,client,informer,lister,deepcopy" \
 github.com/kubeflow/xgboost-1/pkg/client github.com/kubeflow/xgboost-1/pkg/apis \
 xgboost:v1alpha1 \
 --go-header-file ${SCRIPT_ROOT}/hack/boilerplate/boilerplate.go.txt

echo "Generating defaulters for xgboost v1alpha1"
${GOPATH}/bin/defaulter-gen --input-dirs github.com/kubeflow/xgboost-1/pkg/apis/xgboost/v1alpha1 \
 -O zz_generated.defaults \
 --go-header-file ./hack/../hack/boilerplate/boilerplate.go.txt  \
 --output-package github.com/kubeflow/xgboost-1/pkg/apis/xgboost/v1alpha1

...
echo "Generating defaulters for xgboost v1beta1"
${GOPATH}/bin/defaulter-gen --input-dirs github.com/kubeflow/xgboost/pkg/apis/xgboost/v1beta1 \
 -O zz_generated.defaults \
 --go-header-file ./hack/../hack/boilerplate/boilerplate.go.txt  \
 --output-package github.com/kubeflow/xgboost/pkg/apis/xgboost/v1beta1

...
func (r *XGBoostJobReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	_ = context.Background()
	_ = r.Log.WithValues("xgboostjob", req.NamespacedName)
...
func (r *XGBoostJobReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&xgboostjobv1alpha1.XGBoostJob{}).
		Complete(r)
}
